...
public class DefaultWebResponseExceptionTranslator implements WebResponseExceptionTranslator {
	...
	private static class UnauthorizedException extends OAuth2Exception {
		...
		public String getOAuth2ErrorCode() {
			...
			if (clazz.getSimpleName().equals("CompanyNotFoundException")) {
				return "company_not_found";
			} else if (clazz.getSimpleName().equals("CompanyUnavailableException")) {
				return "company_unavailable";
			} else if (clazz.getSimpleName().equals("CompanyExpiredException")) {
				return "company_expired";
			} else if (clazz.getSimpleName().equals("UsernameNotFoundException")) {
	...
	public static void main(String[] args) {
		UnauthorizedException ex = new UnauthorizedException("ttt", new CompanyNotFoundException("ttt"));
		System.out.println(ex.getOAuth2ErrorCode());
	}
}
